...
namespace ConnectedADO {
    ...
    public partial class DataSet4 : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public EmployeeRow AddEmployeeRow(string fname, decimal basic_sal, decimal salary) {
...
namespace ConnectedADO.DataSet4TableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Employee] WHERE (([EmpId] = @Original_EmpId) AND ((@IsNull_fname = 1 AND [fname] IS NULL) OR ([fname] = @Original_fname)) AND ((@IsNull_basic_sal = 1 AND [basic_sal] IS NULL) OR ([basic_sal] = @Original_basic_sal)) AND ((@IsNull_salary = 1 AND [salary] IS NULL) OR ([salary] = @Original_salary)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employee] ([fname], [basic_sal], [salary]) VALUES (@fname, @ba" +
                "sic_sal, @salary);\r\nSELECT EmpId, fname, basic_sal, salary FROM Employee WHERE (" +
                "EmpId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [fname] = @fname, [basic_sal] = @basic_sal, [salary] = @salary WHERE (([EmpId] = @Original_EmpId) AND ((@IsNull_fname = 1 AND [fname] IS NULL) OR ([fname] = @Original_fname)) AND ((@IsNull_basic_sal = 1 AND [basic_sal] IS NULL) OR ([basic_sal] = @Original_basic_sal)) AND ((@IsNull_salary = 1 AND [salary] IS NULL) OR ([salary] = @Original_salary)));
SELECT EmpId, fname, basic_sal, salary FROM Employee WHERE (EmpId = @EmpId)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ConnectedADO.Properties.Settings.Default.SaritaDBConnectionString1;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmpId, fname, basic_sal, salary FROM dbo.Employee";
        ...
        public virtual int Fill(DataSet4.EmployeeDataTable dataTable) {
        ...
        public virtual DataSet4.EmployeeDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSet4.EmployeeDataTable dataTable = new DataSet4.EmployeeDataTable();
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet4.EmployeeDataTable dataTable) {
        ...
        public virtual int Delete(long Original_EmpId, string Original_fname, global::System.Nullable<decimal> Original_basic_sal, global::System.Nullable<decimal> Original_salary) {
        ...
        public virtual int Insert(string fname, global::System.Nullable<decimal> basic_sal, global::System.Nullable<decimal> salary) {
            if ((fname == null)) {
        ...
        public virtual int Update(string fname, global::System.Nullable<decimal> basic_sal, global::System.Nullable<decimal> salary, long Original_EmpId, string Original_fname, global::System.Nullable<decimal> Original_basic_sal, global::System.Nullable<decimal> Original_salary, long EmpId) {
            if ((fname == null)) {
            ...
            if ((Original_basic_sal.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((decimal)(Original_basic_sal.Value));
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[10].Value = ((long)(EmpId));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string fname, global::System.Nullable<decimal> basic_sal, global::System.Nullable<decimal> salary, long Original_EmpId, string Original_fname, global::System.Nullable<decimal> Original_basic_sal, global::System.Nullable<decimal> Original_salary) {
            return this.Update(fname, basic_sal, salary, Original_EmpId, Original_fname, Original_basic_sal, Original_salary, Original_EmpId);
        }
    }
