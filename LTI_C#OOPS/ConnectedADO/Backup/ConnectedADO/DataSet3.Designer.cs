...
namespace ConnectedADO {
    ...
    public partial class DataSet3 : global::System.Data.DataSet {
        ...
        public partial class EmployeesDataTable : global::System.Data.TypedTableBase<EmployeesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public EmployeesRow AddEmployeesRow(string LastName, string FirstName, string City, int salary) {
...
namespace ConnectedADO.DataSet3TableAdapters {
    ...
    public partial class EmployeesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Employees] WHERE (([EmployeeID] = @Original_EmployeeID) AND ([LastName] = @Original_LastName) AND ([FirstName] = @Original_FirstName) AND ((@IsNull_City = 1 AND [City] IS NULL) OR ([City] = @Original_City)) AND ((@IsNull_salary = 1 AND [salary] IS NULL) OR ([salary] = @Original_salary)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employees] ([LastName], [FirstName], [City], [salary]) VALUES " +
                "(@LastName, @FirstName, @City, @salary);\r\nSELECT EmployeeID, LastName, FirstName" +
                ", City, salary FROM Employees WHERE (EmployeeID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employees] SET [LastName] = @LastName, [FirstName] = @FirstName, [City] = @City, [salary] = @salary WHERE (([EmployeeID] = @Original_EmployeeID) AND ([LastName] = @Original_LastName) AND ([FirstName] = @Original_FirstName) AND ((@IsNull_City = 1 AND [City] IS NULL) OR ([City] = @Original_City)) AND ((@IsNull_salary = 1 AND [salary] IS NULL) OR ([salary] = @Original_salary)));
SELECT EmployeeID, LastName, FirstName, City, salary FROM Employees WHERE (EmployeeID = @EmployeeID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ConnectedADO.Properties.Settings.Default.NorthwindConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT EmployeeID, LastName, FirstName, City, salary FROM dbo.Employees";
        ...
        public virtual int Fill(DataSet3.EmployeesDataTable dataTable) {
        ...
        public virtual DataSet3.EmployeesDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSet3.EmployeesDataTable dataTable = new DataSet3.EmployeesDataTable();
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet3.EmployeesDataTable dataTable) {
        ...
        public virtual int Delete(int Original_EmployeeID, string Original_LastName, string Original_FirstName, string Original_City, global::System.Nullable<int> Original_salary) {
        ...
        public virtual int Insert(string LastName, string FirstName, string City, global::System.Nullable<int> salary) {
            if ((LastName == null)) {
        ...
        public virtual int Update(string LastName, string FirstName, string City, global::System.Nullable<int> salary, int Original_EmployeeID, string Original_LastName, string Original_FirstName, string Original_City, global::System.Nullable<int> Original_salary, int EmployeeID) {
            if ((LastName == null)) {
                throw new global::System.ArgumentNullException("LastName");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string LastName, string FirstName, string City, global::System.Nullable<int> salary, int Original_EmployeeID, string Original_LastName, string Original_FirstName, string Original_City, global::System.Nullable<int> Original_salary) {
            return this.Update(LastName, FirstName, City, salary, Original_EmployeeID, Original_LastName, Original_FirstName, Original_City, Original_salary, Original_EmployeeID);
        }
    }
